...
function aubergine {
	...
	WARNINGTXT="#e9ac00"; ERRORTXT="#e95420";
...
function goldspice {
	...
	WARNINGTXT="#e5a400"; ERRORTXT="#e54c00";
...
function heather {
    ...
    WARNINGTXT="#cecd93"; ERRORTXT="#ce75bb";
...
function kashmirblue {
	...
	WARNINGTXT="#a18c44"; ERRORTXT="#a1346c";
...
function rhino {
	...
	WARNINGTXT="#9bd84e"; ERRORTXT="#9b8076";
...
function rossocursa {
	...
	WARNINGTXT="#ccbe00"; ERRORTXT="#cc6600";
...
function willowgrove {
	...
	WARNINGTXT="#aaa63b"; ERRORTXT="#aa4e63";
...
function zanah {
	...
	WARNINGTXT="#ceee47"; ERRORTXT="#ce966f";
...
function build_theme {
	...
	cd "$CURRENTDIR";
	echo "Moving from $TARGETDIR to $THEMEDIR";
	rsync -a -u "$TARGETDIR/$THEMENAME"/ "$THEMEDIR/$THEMENAME";
}
